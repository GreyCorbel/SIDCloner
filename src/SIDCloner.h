...
#pragma region Cmdlet
	...
	/// <para>Command uses explicit domain controllers in Source or Target domain, or discovers suitable Domain Controllers itself, if not specified</para>
	/// <para>Note: Operation may require domain controller in PDC Emulator role</para>
